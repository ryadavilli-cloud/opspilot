...
- **Inspected:** `main` at `fb85d31` plus the retrieval-influence landing, working tree,
  2026-08-19.
...
- **Gates at this tree:** `ruff check` clean; `ruff format --check` clean repository-wide; `mypy`
  ...
  `pytest -q -m "not llm"`: **532 passed, 1 deselected, no xfails**; the pre-commit hook (lint,
