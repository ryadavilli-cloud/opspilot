...
The read-only tool policy, and `safety_validate`'s delegation to the four-check grounding gate's
reference-resolution primitive. Includes the deliberately-unsupported hypothesis that must be
rejected.
"""
